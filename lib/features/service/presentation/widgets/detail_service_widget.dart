...
class DetailServiceWidget extends StatefulWidget {
  const DetailServiceWidget({super.key});

  @override
  State<DetailServiceWidget> createState() => _DetailServiceWidgetState();
}

class _DetailServiceWidgetState extends State<DetailServiceWidget> {
  @override
